...
Rules of the setting are looser or not established. The writing 
...
with Christmas-themed puzzles. The first year accordingly has a more informal feel than 
what would come later. The difficulty spikes and troughs unexpectedly, as with the surprisingly 
...
implement a general rotation matrix to model changes of orientation. (I had yet to learn 
...
reverse-engineering the made-up assembly language provided as the input.
