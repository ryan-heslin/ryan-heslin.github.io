...
_Be absolutely sure you understand what is being asked._ The puzzles often  
...
to the first part!_
Stop right there. The whole point of the second part is that you can't plan for it. 
...
with a fresh variation or two. Expect to see at least one of the following: 
...
Advent of Code is, above all, fun \em a chance to write code that solves 
